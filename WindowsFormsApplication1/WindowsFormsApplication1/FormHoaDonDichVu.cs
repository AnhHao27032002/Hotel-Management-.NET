...
namespace WindowsFormsApplication1
{
    public partial class FormHoaDonDichVu : Form
    {
        ...
        SqlConnection con1;
        SqlCommand cmd1;
        string str1 = "Data Source=ANHHAO\SQLSEVER2012;Initial Catalog=QUANLYKHACHSAN;Integrated Security=True";
        SqlDataAdapter adapter1 = new SqlDataAdapter();
        DataTable table1 = new DataTable();
        //-------------------------------------
        SqlConnection con2;
        SqlCommand cmd2;
        string str2 = "Data Source=ANHHAO\SQLSEVER2012;Initial Catalog=QUANLYKHACHSAN;Integrated Security=True";
